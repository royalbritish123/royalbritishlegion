RoyalBritishLegion-qt: Qt4 GUI for RoyalBritishLegion
===============================
...
Alternatively, install Qt Creator and open the `RoyalBritishLegion-qt.pro` file.

An executable named `RoyalBritishLegion-qt` will be built.
...
A warning for people using the *static binary* version of RoyalBritishLegion on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of RoyalBritishLegion is linked against libdb5.3.
...
installed causes RoyalBritishLegion-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
