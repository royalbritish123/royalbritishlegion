...
static const uint256 hashGenesisBlock("0x0000002bdc19e0d3cc827d91763733a8c3e1201ebcd99a1aeabeb1e6f737f797");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((5 * 3 + 20) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at RoyalBritishLegion block #0
        ...
        // Before RoyalBritishLegion block #0 - get from pregenerated table
