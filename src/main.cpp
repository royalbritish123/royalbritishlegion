...
unsigned int nStakeMinAge = 9 * nOneHour; // 9 hours as zero time weight
unsigned int nStakeMaxAge = 2 * 24 * nOneHour; // 2 days as full weight
...
const string strMessageMagic = "RoyalBritishLegion Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("RoyalBritishLegion-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in RoyalBritishLegion
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // RoyalBritishLegion: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RoyalBritishLegion", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "RBL Genesis";
        CTransaction txNew;
        txNew.nTime = 1500505017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500505017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2785139; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb4, 0xf8, 0xe2, 0xe5 };
