...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RoyalBritishLegion is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("RoyalBritishLegion-start");
