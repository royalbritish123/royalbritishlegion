...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RBL");
    case mBTC: return QString("mRBL");
    case uBTC: return QString::fromUtf8("μRBL");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("RoyalBritishLegions"));
    case mBTC: return QString(QObject::tr("Milli-RoyalBritishLegions (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-RoyalBritishLegions (1 / 1,000,000)"));
    default: return QString("???");
    }
}
