...
{
    resize(850, 550);
    setWindowTitle(tr("RoyalBritishLegion") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a RoyalBritishLegion address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About RoyalBritishLegion"), this);
    aboutAction->setStatusTip(tr("Show information about RoyalBritishLegion"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RoyalBritishLegion"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RoyalBritishLegion addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RoyalBritishLegion addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your RoyalBritishLegion addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("RoyalBritishLegion client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("RoyalBritishLegion client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RoyalBritishLegion network", "", count));
}
...
{
    QString strTitle = tr("RoyalBritishLegion") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid RoyalBritishLegion address or malformed URI parameters."));
    }
